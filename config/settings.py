...
EMAIL_HOST = config('THE_EMAIL_HOST')
EMAIL_HOST_USER = config('THE_EMAIL_HOST_USER')
EMAIL_HOST_PASSWORD = config('THE_EMAIL_HOST_PASSWORD')
EMAIL_PORT = config('THE_EMAIL_PORT')
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False